...
class LikeSerializerForCreateAndCancelBase(serializers.ModelSerializer):
...
class LikeSerializerForCreate(LikeSerializerForCreateAndCancelBase):
    def create(self, validated_data):
        ...
        return instance
class LikeSerializerForCancel(LikeSerializerForCreateAndCancelBase):
    def cancel(self):
        model_class = self.get_model_class(self.validated_data)
        Like.objects.filter(
            content_type=ContentType.objects.get_for_model(model_class),
